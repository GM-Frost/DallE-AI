  ...
  return (
    <section className='max-w-7xl mx-auto'>
            <div>
                ...
                <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Browse through a collection of imaginative and visually stunning images generated by <span className='font-semibold text-xs bg-[#edbc4a] py-1 px-2 rounded-[5px] text-black'>DALL·E AI</span></p>
            </div>
            <div className='mt-16'>
                <FormField
                ...
                {loading ? (
                    ...
                    <>
                       {searchText && (
                        ...
                        {/* Rendering Images below Search Text */}
