  ...
  return (
    <div>
      <div className='flex item-center gap-2 mb-2'>
        ...
        >{labelName}</label>
        {isSurpriseMe && (
          <button type='button' onClick={handleSurpriseMe} className="font-semibold text-xs bg-[#edbc4a] py-1 px-2 rounded-[5px] text-black">Click here to Surprise Me !</button>
        )}
      </div>
      <input 
      type={type} 
